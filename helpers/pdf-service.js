...
function BuildPDF(order, dataCallback, endCallback) {
  ...
  try {
    doc.image(
      '/public/images/header/giftora.png',
      doc.page.width / 2 - 40,
      30,
      { width: 80 },
    );
  ...
  doc
    ...
    .text('Email: support@giftora.com | Phone: +91-9061318498', {
      align: 'center',
    });
  doc.moveDown(1.5);
  doc
  ...
  doc.rect(50, tableTop, 500, 22).fill('#f5f6fa');
  doc
    .fillColor('#2E3A59')
    .fontSize(12)
    .font('Helvetica-Bold')
  ...
  let offset = 10;
  doc.rect(350, totalsTop, 200, 120).fill('#f5f6fa');
  doc
    .fontSize(12)
    .fillColor('#2E3A59')
    .font('Helvetica-Bold')
  ...
  doc
    ...
    .fillColor('#2E3A59')
    .font('Helvetica-Bold')
    .text('Thank you for shopping with us!', 0, doc.page.height - 90, {
      align: 'center',
    })
    .font('Helvetica')
    .fontSize(9)
