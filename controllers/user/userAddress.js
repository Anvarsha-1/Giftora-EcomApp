...
const loadAddAddresses = async (req, res) => {
    try {
        const userData = req.session.user ? await User.findById(req.session.user) : undefined
        return res.render('addAddress', { user: userData })
    } catch (error) {
        console.log("Error while loading add address", error.message)
    }
}
...
const UpdateAddresses = async (req, res) => {
    try {
        ...
        console.log("Error while add address ", error.message)
...
const loadEditAddress = async (req, res) => {
    try {
        ...
        console.log("Error while loading edit page", error.message)
        res.render('error', {
            title: "Something went wrong",
            message: "We couldn’t load your edit address page. Please try again later."
        })
    }
}
